...
namespace Farkas_Szabolcs_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {

        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Farkas_Szabolcs_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Farkas_Szabolcs_Lab2Context context,
